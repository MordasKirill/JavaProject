...
public class ConnectionPool {
    ...
    public ConnectionPool connectionPool(String url, String password, String userName, String driver, int initConnCnt){
        return new ConnectionPool(url, password, userName, driver, initConnCnt);
    }
