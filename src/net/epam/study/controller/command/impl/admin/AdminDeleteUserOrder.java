...
public class AdminDeleteUserOrder implements Command {
    private static final String ATTR_ERROR = "error";
    private static final String MSG_ERROR = "Delete order error!";
    /**
     * Logger to get error log
     */
    private static final Logger LOG = Logger.getLogger(AdminDeleteUserOrder.class);
    ...
    public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (user != null || validationService.isUser(user.getRole())) {
            ...
            try {
                ...
                LOG.log(Level.ERROR, "Admin delete user/order error.", e);
